...
Route::patch('/changes_car', [ChangesCarController::class, 'update']);
...
Route::post('/travel_expenses/general/report', [TravelExpensesController::class, 'GenerateReportGeneralTravels']);
...
Route::patch('/claims', [ClaimsController::class, 'update']);
Route::delete('/claims', [ClaimsController::class, 'delete']);
...
Route::get('/claimsimg/{id}/{zize}', [ClaimsController::class, 'image']);
