    ...
    public function login(Request $request)
    {
        ...
        try {
            ...
            $userJpa = User::select([
                ...
                'people.department AS person__department',
                'people.province AS person__province',
                'people.distric AS person__distric',
                ...
                'branches.department AS branch__department',
                'branches.province AS branch__province',
                'branches.distric AS branch__distric',
