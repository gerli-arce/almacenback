        ...
        try {
            ...
            foreach($PhotographsByPlant as $image){
                ...
                <div style='page-break-before: always;'>
                    ...
                    <center>
                        <img src='https://almacendev.fastnetperu.com.pe/api/plant_pendingimgs/{$image->id}/full' alt='-' style='background-color: #38414a; object-fit: contain; object-position: center center; cursor: pointer; max-width: 650px; max-height: 700px; width: auto; height: auto; margin-top:5px;border:solid 2px #000;'>
                    </center>
                </div>
                ";
                $count +=1;
